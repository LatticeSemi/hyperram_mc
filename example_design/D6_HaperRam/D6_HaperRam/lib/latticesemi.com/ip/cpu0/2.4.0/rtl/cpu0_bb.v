...
*******************************************************************************/
module cpu0 (clk_system_i, clk_realtime_i, rstn_i, system_resetn_o, uart_rxd_i,
    uart_txd_o, irq3_i, irq2_i, dBusAxi_aw_payload_id, dBusAxi_aw_payload_addr,
    ...
    input  [0:0]  irq3_i;
    input  [0:0]  irq2_i;
    output  [1:0]  dBusAxi_aw_payload_id;
    ...
    input  [1:0]  dBusAxi_r_payload_id;
    ...
    output  [1:0]  iBusAxi_aw_payload_id;
    ...
    input  [1:0]  iBusAxi_r_payload_id;
